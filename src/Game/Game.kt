...
object Game {
    ...
    //TODO сделать логику для кона. в переменную закидываем карту, если её никто не побил значит это победитель
    //если побили то в переменную помещается новая карта.   
...
//        var playerName: String = readLine()!!.toString()
    ...
    //TODO Нужно придумать как будет обходиться круг когда атакующий первый или последний
    fun getCircle(i: Int){
        when (i){
            0-> {
                Players.forEach {p ->
